    ...
    2997: function(r, n, o) {
        ...
        let Router = class Router {
            ...
            async change(r, n, o, l, u) {
                ...
                this._inFlightRoute && this.clc && ($ || Router.events.emit("routeChangeError", buildCancellationError(), this._inFlightRoute, et),
                this.clc(),
                this.clc = null),
                o = (0,
                M.addBasePath)((0,
                ...
                Y && "/_error" !== eo) {
                    ...
                    o.startsWith("/")) {
                        ...
                        S.default)((0,
                        M.addBasePath)((0,
                        C.addLocale)(er, Q.locale), !0), G, V, ei, r=>resolveDynamicRoute(r, G), this.locales);
                        if (r.externalDest)
                            return handleHardNavigation({
                                url: o,
                                router: this
                ...
                try {
                    ...
                    if (X || l.shallow || await this._bfl(o, "resolvedAs"in s ? s.resolvedAs : void 0, Q.locale),
                    "route"in s && ef) {
                        eu = eo = s.route || eu,
                        ...
                        b.isDynamicRoute)(eo)) {
                            ...
                            M.addBasePath)((0,
                            C.addLocale)(new URL(o,location.href).pathname, Q.locale), !0)
                              , n = r;
                            (0,
                            I.hasBasePath)(n) && (n = (0,
                            j.removeBasePath)(n));
                    ...
                    if ((s.__N_SSG || s.__N_SSP) && s.props) {
                        ...
                        if (Q.isPreview = !!s.props.__N_PREVIEW,
                        s.props.notFound === z) {
                            let r;
                            try {
...
*/
    ...
    8018: function(r) {
        var n, o, l, u, s, f, d, h, g, _, y, P, b, E, S, R, O, w, A, C, x, j, M, I, N, L, D, k, F, U, H, B, W, q, z, G, V, X, Y, Q, K, $, J, Z, ee, et;
        (n = {}).d = function(r, o) {
            for (var l in o)
